    ...
    <div class="card submit-card">
      ...
      <div class="card__body">
        ...
        <div v-if="uploadedSubmission" class="upload-result">
          <div class="upload-result__title">
            提交结果
            <div style="display:flex;gap:8px;margin-left:auto;">
              <el-button size="small" @click="doPreviewSubmitFile(uploadedSubmission.id, uploadedSubmission.fileName, uploadedSubmission.contentType)">预览</el-button>
              <el-button size="small" type="primary" @click="doDownloadSubmitFile(uploadedSubmission.id, uploadedSubmission.fileName)">下载</el-button>
            </div>
          </div>
...
function doPreviewSubmitFile(id: number, fileName: string, contentType?: string) { previewFileId.value = id; previewFile(id, fileName, contentType); }
function doDownloadSubmitFile(id: number, fileName: string) { downloadFile(id, fileName); }
