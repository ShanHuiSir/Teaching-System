...
export const FILE_ICONS: Record<string, FileIconDef> = {
  ...
  java: {
    viewBox: '0 0 24 24',
    paths: [`<path d="M11.506 23.363l1.287-.756-1.438.4..."/><path .../>`],
  },
  python: {
    viewBox: '0 0 24 24',
    paths: [`<circle cx="12" cy="12" r="10"/><path d="M8 10l4-4 4 4M8 14l4 4 4-4"/>`],
  },
  cpp: {
    viewBox: '0 0 24 24',
    paths: [`<path d="M435.28 113.28L247.19 4.69..."/><path .../>`],
  },
  golang: {
    viewBox: '0 0 24 24',
    paths: [`<path d="M400.1 194.8C389.2 197.6..."/><path .../>`],
  },
  rust: {
    viewBox: '0 0 24 24',
    paths: [`<path d="M15 3.77..."/><path .../>`],
  },
  html: {
    viewBox: '0 0 32 32',
    paths: [
  ...
  js: {
    viewBox: '0 0 32 32',
    paths: [`<path d="M0 0h32v32H0zM29.38 24.37c-.234-1.464..."/><path d="M17.401 14.708H14.4..."/>`],
  },
  css: {
    viewBox: '0 0 32 32',
    paths: [
  ...
  scss: {
    viewBox: '0 0 24 24',
    paths: [`<path d="M16.171 18.7c-.481.221-1.008.509-2.063 1.088..."/><path d="M11.346 26.539..."/>`],
  },
  sass: {
    viewBox: '0 0 24 24',
    paths: [`<path d="M15.092 22.146c-.015.03-.03.054 0 0zM27.548 17.796..."/><path d="M6.089 25.031..."/>`],
  },
  sql: {
    viewBox: '0 0 24 24',
    paths: [`<path d="M64 16c-26.51 0-48 21.49-48 48s21.49 48 48 48..."/><path d="M105.29 87.19..."/>`],
  },
  kotlin: {
    viewBox: '0 0 32 32',
    paths: [`<path d="M1.734 32l15.068-15.333L31.999 32zM0 0h16L0 16.667zM17.865 0L0 18.667V32L32 0z"/>`],
  },
}
