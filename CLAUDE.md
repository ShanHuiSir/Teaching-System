...
- **编码前先读文档**：在编写或修改任何代码之前，AI **必须**先阅读 `docs/设计期文档/` 目录下的相关设计文档，理解当前设计意图后再动手。
- **未覆盖需求须补档**：当用户需求在设计文档中未明确规定时，AI 须在实现完成后，主动在对应的设计文档末尾追加更新，并附上日期分隔符。格式如下：
...
- **目录同步**：若新增了新的设计文档，须同步更新 `00-设计期文档目录.md` 的文档清单。
